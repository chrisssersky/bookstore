    ...
    <body>
        ...
        <div class="container main_box_head">
            <div class="row">
                ...
                <div id="login_button_red" class="col-md-2">
                    <?php if ($_SESSION['auth'] == true && $_SESSION['login'] == true) {
                        ?> <button  id="logout" class="login-btn">Wyloguj <span class="glyphicon glyphicon-log-out"></span></button> <?php } else {
                        ?>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="login_checker.php" method="post" id="login-form">
                                        ...
                                        <div class="button_right">
                                            <input type="submit" class="btn-form btn-login" name="submit" value="Zaloguj się"/>
                                        </div>
                                    </form>
                                </div>
                ...
                <div class="col-md-2">
                    <?php if ($_SESSION['auth'] == true && $_SESSION['login'] == true) { ?> 
                        <button id="add_user_main_btn1" class="regiser-btn disabled" type="button">
                            ...
                            <div class="modal-content">
                                ...
                                <div id="add_user_box" class="modal-body">
                                    <form action="form_response.php" method="post" id="add_user">
                                        ...
                                        <div class="button_right">
                                            <input type="submit" class="btn-form btn-login" name="submit" value="Zarejestruj się"/>   
                                        </div>
                                    </form>
                                </div>
                                <div id="add_user_success" class="modal-body"></div>
                                <div id="add_user_success1" class="modal-body"></div>
                        ...
                        <div class="col-md-8">
                            <div class="new_ones">
                                ...
                                <form action="send_email.php" method="post" id="send_email">
                                    ...
                                    <input class="contact-input" placeholder="E-mail" type="email" id="e_mail" name="email"/>
                                    <label>Temat:</label>
                    ...
                    <div class="row main_box_1">
                        ...
                        <div class="col-md-8">
                            <div class="new_ones">
                                ...
                                <div class="makespace"><i class="fa fa-exclamation-circle fa-5x"></i><br/>W przygotowaniu...</div>
                            </div>
                        </div>
                    </div>
                </div>
