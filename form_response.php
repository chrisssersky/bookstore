...
if (isset($_POST['login'], $_POST['passwd'], $_POST['email'], $_POST['first_name'], $_POST['last_name'], $_POST['date_of_birth'], $_POST['sex'], $_POST['address'], $_POST['country']) && !empty($_POST['login']) && !empty($_POST['passwd']) &&
...
if ($result1) {
    ...
    echo $msg = '<center><span class="hello-message">Witaj <b>' . $first_name . ' ' . $last_name . '</b>!</span></center><br/>
           Login: <b>' . $login . '</b><br/> E-mail: <b>' . $email . '</b><br/><br/>
           Teraz możesz zalogować się do serwisu używając swojego loginu oraz hasła podanego w formularzu. Dziękujemy za wybranie naszego serwisu!';
} else {
    echo $msg = 'Coś poszło nie tak..';
}
